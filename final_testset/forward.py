...
model_path = "path/km_weights_ES.pth"
scaler_path = "path/km_scalers_ES.pkl"
val_prepath = "path/ES_predicted.npy"
val_labelpath = "path/ES_label.npy"
#init
b_s = 839
