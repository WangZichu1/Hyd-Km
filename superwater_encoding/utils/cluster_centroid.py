...
################################################################################################### 
    ...
    final_indices = np.delete(final_indices, list(to_delete))
    return np.array(final_centroids),np.array(final_indices)